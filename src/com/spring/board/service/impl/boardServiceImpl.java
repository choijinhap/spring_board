...
public class boardServiceImpl implements boardService{
	...
	@Override
	public List<ComcodeVo> selectComcodeList(String codeType) throws Exception {
		// TODO Auto-generated method stub
		return boardDao.selectComcodeList(codeType);
	}

	@Override
	public int selectPartBoardCnt(PageVo pageVo) throws Exception {
		// TODO Auto-generated method stub
		return boardDao.selectPartBoardCnt(pageVo);
	}
