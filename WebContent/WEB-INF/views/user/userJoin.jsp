...
<script type="text/javascript">
	...
	$j(document).ready(function(){
		...
		$j("#submit").on("click",function(){
			if(formIdCheck()&&formPwCheck()&&formNameCheck()&&formPhoneCheck()&&formPostNoCheck()){
	...
	function formIdCheck(){
		if($j("#ckFlag").val()==1 && $j("#ckId").val()==$j("#userId").val()){
			return true;
		}
...
<input type="hidden" id="ckId" value="!@#!@$!@$!@#!@$!@#!">
	<form class="userJoin" name="join" method="post">
		...
		<table border="1" align="center">
			<tr>
				<td align="center"><a href="/board/boardList.do">List</a></td>
			</tr>
			<tr>
				<td>id</td>
				<td><input type="text" size="20" name="userId" id="userId"></td>
				<td><input type="button" id="idCk" name="idCk" value="중복확인" onclick="javascript:idCheck()"></td>
			</tr>
			<tr>
				<td>pw</td>
			...
			<tr>
				<td>pw check</td>
				<td><input type="password" maxlength="12" size="20" name="userPwCheck" id="userPwCheck"></td>
			</tr>
			<tr>
				<td>name</td>
				<td><input type="text" size="20" maxlength="10" name="userName" id="userName"></td>
			</tr>
			<tr>
				<td>phone</td>
				<td>
					...
					</select> <input type="text" size="6" maxlength="4" name="userPhone2" id="userPhone2">
					<input type="text" size="6" maxlength="4" name="userPhone3" id="userPhone3"></td>
			</tr>
			<tr>
				<td>postNo</td>
				<td><input type="text" size="20" maxlength="8" name="userAddr1" id="userAddr1" onKeyup="inputPostNo(this);"></td>
			</tr>
			<tr>
				<td>address</td>
				<td><input type="text" size="20" name="userAddr2" id="userAddr2"></td>
			</tr>
			<tr>
				<td>company</td>
				<td><input type="text" size="20" name="userCompany" id="userCompany"></td>
			</tr>
			<tr>
